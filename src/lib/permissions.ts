...
export const actions = {
  ...
  "volunteer.manage": ["ADMIN", "ORGANIZER", "VOLUNTEER"],
  ...
  "finance.read": ["ADMIN", "ORGANIZER", "TREASURER"],
  "finance.write": ["ADMIN", "ORGANIZER", "TREASURER"],
  "expenseClaim.create": ["ADMIN", "ORGANIZER", "TREASURER", "VOLUNTEER", "ARTIST", "VIEWER"],
  "shopping.read": ["ADMIN", "ORGANIZER", "TREASURER"],
  "shopping.write": ["ADMIN", "ORGANIZER"],
  "runOfShow.read": ["ADMIN", "ORGANIZER", "TREASURER", "VOLUNTEER", "ARTIST", "VIEWER"],
  "runOfShow.write": ["ADMIN", "ORGANIZER"],
  "equipment.read": ["ADMIN", "ORGANIZER", "TREASURER", "ARTIST", "VIEWER"],
